...
const Sidepar = () => {
  ...
  return (
    <div className="inline-flex flex-col justify-between bg-[#f0f4f9] min-h-screen py-[10px] px-8 duration-75  ">
      <div>
        <img
        ...
        {open && (
          <div className="mt-5 font-semibold">
            <p>Recent</p>
            <div
              className="inline-flex items-center gap-3 py-[15px] px-4 hover:bg-[#e6eaf1] mt-2 
